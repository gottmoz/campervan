function defaultPidMappings() {
  return [
    ...
    { functionKey: "alternatorDutyPercent", label: "Alternator duty cycle", enabled: true, mode: "Ford PID", service: "22", pid: "0598", formula: "B4", unit: "%", category: "Charging / Electrical", module: "PCM", setupCommands: ["ATSH7E0"], min: 0, max: 100, pollIntervalMs: 2000, timeoutMs: 2000, decimals: 0 },
    { functionKey: "generatorCurrentA", label: "Generator / vehicle battery current", enabled: true, mode: "Ford PID", service: "22", pid: "402B", formula: "U16_OFFSET_32768", unit: "A", category: "Charging / Electrical", module: "BCM", setupCommands: ["ATSH000726", "STCAFCP726,72E"], min: -250, max: 250, pollIntervalMs: 2000, timeoutMs: 2000, decimals: 0 },
    { functionKey: "vehicleBatteryVoltage", label: "Vehicle battery voltage", enabled: true, mode: "Ford PID", service: "22", pid: "402A", formula: "U16_DIV_256", unit: "V", category: "Charging / Electrical", module: "BCM", setupCommands: ["ATSH000726", "STCAFCP726,72E"], min: 10, max: 16, pollIntervalMs: 2000, timeoutMs: 2000, decimals: 2 },
...
const simulator = {
  ...
  getVictronSettings: () => ({
    ...
    devices: [
      { id: "victron_smartsolar_mppt", displayName: "Victron SmartSolar MPPT", type: "solar_charger", expectedService: "com.victronenergy.solarcharger.*", enabled: true },
      { id: "victron_ip22_30a", displayName: "Victron Blue Smart IP22 30A", type: "ac_charger", expectedService: "com.victronenergy.charger.*", enabled: true },
      { id: "victron_cerbo_gx", displayName: "Victron Cerbo GX", type: "gx", expectedService: "com.victronenergy.system", enabled: true },
    ],
    readOnly: true,
  }),
  ...
  testVictronConnection: () => ({ state: "Configured", host: "cerbo-gx.local", readOnly: true }),
  getVictronSnapshot: () => ({
    state: "Configured",
    host: "cerbo-gx.local",
    gxDevice: "Cerbo GX",
    devices: simulator.getVictronSettings().devices,
    dbusPaths: {
      battery: ["/Dc/Battery/Soc", "/Dc/Battery/Voltage", "/Dc/Battery/Current", "/Dc/Battery/Power"],
      solar: ["/Dc/Pv/Power", "/Yield/Power", "/History/Daily/0/Yield", "/State", "/ErrorCode"],
      shore: ["/Ac/In/0/Connected", "/Ac/ActiveIn/Source"],
      chargers: ["com.victronenergy.charger.*", "/Dc/Charger/Power"],
    },
    telemetry: { source: "waiting_for_cerbo_gx" },
    readOnly: true,
  }),
